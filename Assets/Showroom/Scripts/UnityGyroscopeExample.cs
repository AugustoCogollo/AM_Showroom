...
public class UnityGyroscopeExample : MonoBehaviour
{
    ...
    protected void OnGUI()
    {
        ...
        GUILayout.Label("Status of the Gyroscope: " + Input.gyro.enabled);
        GUILayout.Label("The Attitude of the Device is: " + Input.gyro.attitude);
        GUILayout.Label("Gravity Acceleration: " + Input.gyro.gravity);
        GUILayout.Label("User Acceleration" + Input.gyro.userAcceleration);
        GUILayout.Label("Rotation: " + Input.gyro.rotationRate);
        GUILayout.Label("Unbiased Rotation: " + Input.gyro.rotationRateUnbiased);
        GUILayout.Label("Gyroscope Interval (frames/s): " + Input.gyro.updateInterval * Time.deltaTime);
    }
    ...
    void HomeworkDebugging()
    {
        Debug.Log("Status of the Gyroscope: " + Input.gyro.enabled);
        Debug.Log("The Attitude of the Device is: " + Input.gyro.attitude);
        Debug.Log("Gravity Acceleration: " + Input.gyro.gravity);
        Debug.Log("User Acceleration" + Input.gyro.userAcceleration);
        Debug.Log("Rotation: " + Input.gyro.rotationRate);
        Debug.Log("Unbiased Rotation: " + Input.gyro.rotationRateUnbiased);
        Debug.Log("Gyroscope Interval (frames/s): " + Input.gyro.updateInterval);
    }
}